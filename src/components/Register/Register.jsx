...
>
  {/* Logo */}
  <div className="p-4">
    <span className="font-sans font-extrabold text-white text-2xl rounded p-1">
      News Flow
    </span>
  </div>
      ...
      >
        <Form className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Field
              name="username"
              className="px-4 py-2 rounded-2xl bg-gray-200 placeholder-gray-500 focus:outline-none"
          ...
          <div className="flex flex-col gap-1">
            ...
            <Field
              ...
              type="number"
              min="16"
              className="px-4 py-2 rounded-2xl bg-gray-200 focus:outline-none"
          ...
          <div className="flex items-center justify-between mt-2">
            <button
              type="submit"
              className="bg-blue-600 text-white px-6 py-2 font-bold rounded hover:bg-blue-700 transition"
            >
              Register
            </button>
